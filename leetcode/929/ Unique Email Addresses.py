...
dots in the local name.  For example, "alice.z@leetcode.com" and "alicez@leetcode.com" forward to the same email address.  (Note that this rule does not apply for domain names.)
    ...
    def numUniqueEmails(self, emails):
        ...
        for email in emails:
            if at in email:
                ...
                email_address =  '{}@{}'.format(local_name.split('+')[0].replace('.', ''), domain)
